...
class WC_API_Client_HTTP_Request {
	...
	public function __construct( $args ) {
		...
		//
		//$auth = new WC_API_Client_Authentication( $this->request->url, $args['consumer_key'], $args['consumer_secret'] );
		//$username = $auth->get_consumer_key();
		//$password = $auth->get_consumer_secret();
