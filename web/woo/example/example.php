...
try {
	...
	//$client = new WC_API_Client( 'https://www.jetpilot.co.th', 'ck_dcbc1be1c7eb230f2b86cbed56009d80e8d08d69', 'cs_b793e2d8f0bc20f67684e7d21d0963c9746c3408', $options );
	//cs_e094795e602fa98a1590a166a56c3bede542b967
	$client = new WC_API_Client( 'https://www.jetpilot.co.th', 'ck_6e09825027fccbc9917ef31117c4dfad328b2613', 'cs_e094795e602fa98a1590a166a56c3bede542b967', $options );
	// coupons
	...
	//print_r( $client->products->create( array( 'title' => 'Test Product', 'type' => 'simple', 'regular_price' => '9.99', 'description' => 'test', 'categories' => [''] ) ) );
	//print_r( $client->products->update( 699, array( 'regular_price' => 800 ) ) );
